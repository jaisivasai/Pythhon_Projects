...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\DELL PC\PycharmProjects\1.Basic of Python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\DELL PC\PycharmProjects\1.Basic of Python\venv\Scripts\deactivate.nu'
